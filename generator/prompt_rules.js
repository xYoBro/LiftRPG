  ...
  window.SCHEMA_PUZZLES = [
    ...
    '- `kind` (string, required): "logic-grid" | "nonogram" | "sudoku" | "kakuro" | "kenken" | "truth-tellers". No other value is accepted — the dense crossword has no solver here yet and is refused.',
    '',
  ...
  window.INST_LUDIC_SPINE = [
    ...
    '  `deduction-board` (a logic grid, a nonogram, a sudoku or a truth-teller board — machine-proven',
    '  solvable and unique) ·',
